...
{
	_colorAttchmentFormat = format;
	//connect the format to the renderInfo structure
	_renderInfo.colorAttachmentCount = 1;
	_renderInfo.pColorAttachmentFormats = &_colorAttchmentFormat;
}
	...
	VkShaderModule* outShaderModule)
{
	...
	// find what the size of the file is by looking up the location of the cersor
